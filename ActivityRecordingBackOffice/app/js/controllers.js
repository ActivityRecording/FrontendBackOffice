...
function ApprovalCtrl($scope, $routeParams, $location, Activity, TimePeriod, TreatmentCase) {
...
function ActivitiesCtrl($scope, $routeParams, $location, Activity, TimePeriod, Supplier) {
